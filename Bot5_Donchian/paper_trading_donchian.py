...
«Найденная стратегия»). На отложенном периоде, который в отборе не
участвовал: 250 сделок, WR 33.2%, +0.192R на сделку после комиссий.
...
Главное отличие от прежних ботов проекта:
  ...
  переживает комиссию: она съедает 0.047R вместо 0.207R.
